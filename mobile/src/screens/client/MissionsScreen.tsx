...
const tabs: { id: MissionStatus; label: string }[] = [
  ...
  { id: "completed", label: "Termin\ées" },
  { id: "validated", label: "Valid\ées" },
...
const missions: Mission[] = [
  {
    ...
    initials: "JM",
    type: "Plomberie \— R\éparation fuite",
    date: "15 mars 2026",
    amount: "320,00\€",
    status: "active",
  ...
  },
  {
    ...
    artisan: "Sophie M.",
    initials: "SM",
    type: "\Électricit\é \— Installation prise",
    date: "10 mars 2026",
    amount: "195,00\€",
    status: "completed",
    statusLabel: "Termin\ée",
